import {
  ...
  injected,
  mock
} from "./chunk-TBRTOSA7.js";
import {
  withRetry,
  withTimeout
} from "./chunk-UN7NFRCU.js";
import "./chunk-EMHK2SLC.js";
import {
      ...
      if (!metamask) {
        if (!metamaskPromise) {
          const { createEVMClient } = await (async () => {
            try {
              return import("./connectors_false-Q6HPXXYR.js");
            } catch {
        ...
        try {
          if (!accounts?.length && !isReconnecting) {
            const { RpcSchema } = await (() => {
              try {
                return import("./connectors_false-U6ZXQUQ5.js");
              } catch {
            ...
            const { z } = await (() => {
              try {
                return import("./connectors_false-XN6YWTWE.js");
              } catch {
