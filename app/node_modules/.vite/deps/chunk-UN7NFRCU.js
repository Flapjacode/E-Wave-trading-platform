...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-JOHYOCFA.js");
  const signature_ = (() => {
...
function verify(options) {
  ...
  return secp256k12.verify(signature, from2(payload), toBytes2(publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
//# sourceMappingURL=chunk-UN7NFRCU.js.map
